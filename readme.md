# Spring PetClinic Sample Application  [![Java CI with Maven](https://github.com/karthikChandrasekaran10/spring-petclinic/actions/workflows/maven.yml/badge.svg)](https://github.com/karthikChandrasekaran10/spring-petclinic/actions/workflows/maven.yml)
